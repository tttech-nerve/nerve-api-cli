...
read -p "Enter the Nerve management system URL (without https://): " nerve_url
...
echo "export MS_URL='$nerve_url'" >> ~/.bashrc
echo "export MS_USR='$nerve_username'" >> ~/.bashrc
echo "export MS_PSW='$nerve_password'" >> ~/.bashrc
